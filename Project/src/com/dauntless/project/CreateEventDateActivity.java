...
public class CreateEventDateActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_create_event_date);
		
		Intent intent = getIntent();
	    event = intent.getStringExtra(CreateEventTypeActivity.EVENT);
	...
	public void dayMonday(View view) {
	    Intent intent = new Intent(this, CreateEventTimeActivity.class);
